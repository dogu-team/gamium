...
export class QueryObjectInteractableParam implements flatbuffers.IUnpackableObject<QueryObjectInteractableParamT> {
  ...
  static getRootAsQueryObjectInteractableParam(bb: flatbuffers.ByteBuffer, obj?: QueryObjectInteractableParam): QueryObjectInteractableParam {
    return (obj || new QueryObjectInteractableParam()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsQueryObjectInteractableParam(bb: flatbuffers.ByteBuffer, obj?: QueryObjectInteractableParam): QueryObjectInteractableParam {
  ...
  static endQueryObjectInteractableParam(builder: flatbuffers.Builder): flatbuffers.Offset {
  ...
  unpack(): QueryObjectInteractableParamT {
    return new QueryObjectInteractableParamT(this.objectId(), this.checkMoving(), this.checkRaycast());
  }
...
export class QueryObjectInteractableParamT implements flatbuffers.IGeneratedObject {
  constructor(public objectId: string | Uint8Array | null = null, public checkMoving: boolean = false, public checkRaycast: boolean = false) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const objectId = this.objectId !== null ? builder.createString(this.objectId!) : 0;

    return QueryObjectInteractableParam.createQueryObjectInteractableParam(builder, objectId, this.checkMoving, this.checkRaycast);
  }
}
