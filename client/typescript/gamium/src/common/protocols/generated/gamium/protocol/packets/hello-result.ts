...
export class HelloResult implements flatbuffers.IUnpackableObject<HelloResultT> {
  ...
  static getRootAsHelloResult(bb: flatbuffers.ByteBuffer, obj?: HelloResult): HelloResult {
    return (obj || new HelloResult()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsHelloResult(bb: flatbuffers.ByteBuffer, obj?: HelloResult): HelloResult {
  ...
  gamiumVersion(optionalEncoding: flatbuffers.Encoding): string | Uint8Array | null;
  ...
  envs(index: number, obj?: Env): Env | null {
    ...
    return offset ? (obj || new Env()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
  }
  ...
  static addGamiumVersion(builder: flatbuffers.Builder, gamiumVersionOffset: flatbuffers.Offset) {
    builder.addFieldOffset(2, gamiumVersionOffset, 0);
  }

  static addFramesFromStart(builder: flatbuffers.Builder, framesFromStart: bigint) {
    builder.addFieldInt64(3, framesFromStart, BigInt('0'));
  }

  static addSecondsFromStart(builder: flatbuffers.Builder, secondsFromStart: number) {
    builder.addFieldFloat32(4, secondsFromStart, 0.0);
  }

  static addClientSequence(builder: flatbuffers.Builder, clientSequence: number) {
  ...
  static createEnvsVector(builder: flatbuffers.Builder, data: flatbuffers.Offset[]): flatbuffers.Offset {
  ...
  unpackTo(_o: HelloResultT): void {
    ...
    _o.envs = this.bb!.createObjList<Env, EnvT>(this.envs.bind(this), this.envsLength());
  }
}
...
export class HelloResultT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    const appVersion = this.appVersion !== null ? builder.createString(this.appVersion!) : 0;
    const gamiumVersion = this.gamiumVersion !== null ? builder.createString(this.gamiumVersion!) : 0;
    const envs = HelloResult.createEnvsVector(builder, builder.createObjectOffsetList(this.envs));

    return HelloResult.createHelloResult(builder, appName, appVersion, gamiumVersion, this.framesFromStart, this.secondsFromStart, this.clientSequence, envs);
  }
}
