...
Below is an example of customizing the processing for [findObjects](../gamium-client/api/client/typescript/classes/gamium-client#findobjects-) and [move](..../gamium-client/api/client/typescript/classes/player#move-) requests.
