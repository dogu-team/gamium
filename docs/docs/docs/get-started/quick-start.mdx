...
1. Open the `gamium-unity-samples/client/python` directory with Visual Studio Code.
2. Open the terminal and execute the following command.
   - This command initializes the automation script project, connects to the running gamium engine, and runs the automation script.
...
- You can learn what functions and how to control them with client scripts from [Client document](../client/write-testscript) and [API document](/api/api-reference).
