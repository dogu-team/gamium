...
Below is an example of customizing the processing for [findObjects](../gamium-client/api/classes/gamium-client#findobjects-) and [move](..../gamium-client/api/classes/player#move-) requests.
