...
export class RpcBy {
  constructor(public readonly by: ExecuteRpcBy, public readonly className: string, public readonly targetName: string, public readonly params: unknown[]) {}
  static method(classPath: string, methodName: string, ...params: unknown[]): RpcBy {
