...
export class DumpObjectsHierarchyParam
  implements flatbuffers.IUnpackableObject<DumpObjectsHierarchyParamT>
{
  ...
  static getRootAsDumpObjectsHierarchyParam(
    bb: flatbuffers.ByteBuffer,
    obj?: DumpObjectsHierarchyParam
  ): DumpObjectsHierarchyParam {
    return (obj || new DumpObjectsHierarchyParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsDumpObjectsHierarchyParam(
    bb: flatbuffers.ByteBuffer,
    obj?: DumpObjectsHierarchyParam
  ): DumpObjectsHierarchyParam {
  ...
  static endDumpObjectsHierarchyParam(
    builder: flatbuffers.Builder
  ): flatbuffers.Offset {
  ...
  static createDumpObjectsHierarchyParam(
    builder: flatbuffers.Builder,
    objectIdOffset: flatbuffers.Offset,
    depth: number
  ): flatbuffers.Offset {
...
export class DumpObjectsHierarchyParamT
  implements flatbuffers.IGeneratedObject
{
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return DumpObjectsHierarchyParam.createDumpObjectsHierarchyParam(
      builder,
      objectId,
      this.depth
    );
