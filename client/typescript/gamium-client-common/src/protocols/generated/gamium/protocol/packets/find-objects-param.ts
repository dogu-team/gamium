...
import {
  ObjectLocator,
  ObjectLocatorT,
} from "../../../gamium/protocol/types/object-locator.js";

export class FindObjectsParam
  implements flatbuffers.IUnpackableObject<FindObjectsParamT>
{
  ...
  static getRootAsFindObjectsParam(
    bb: flatbuffers.ByteBuffer,
    obj?: FindObjectsParam
  ): FindObjectsParam {
    return (obj || new FindObjectsParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsFindObjectsParam(
    bb: flatbuffers.ByteBuffer,
    obj?: FindObjectsParam
  ): FindObjectsParam {
  ...
  static addLocator(
    ...
    locatorOffset: flatbuffers.Offset
  ) {
  ...
  unpack(): FindObjectsParamT {
    return new FindObjectsParamT(
      this.locator() !== null ? this.locator()!.unpack() : null
    );
  }
