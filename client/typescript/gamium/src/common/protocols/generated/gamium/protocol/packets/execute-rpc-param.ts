...
export class ExecuteRpcParam implements flatbuffers.IUnpackableObject<ExecuteRpcParamT> {
  ...
  static getRootAsExecuteRpcParam(bb: flatbuffers.ByteBuffer, obj?: ExecuteRpcParam): ExecuteRpcParam {
    return (obj || new ExecuteRpcParam()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsExecuteRpcParam(bb: flatbuffers.ByteBuffer, obj?: ExecuteRpcParam): ExecuteRpcParam {
  ...
  by(): ExecuteRpcBy {
    ...
    return offset ? this.bb!.readInt16(this.bb_pos + offset) : ExecuteRpcBy.Method;
  }
  ...
  targetName(optionalEncoding: flatbuffers.Encoding): string | Uint8Array | null;
  ...
  paramDocuments(index: number, optionalEncoding: flatbuffers.Encoding): string | Uint8Array;
  paramDocuments(index: number, optionalEncoding?: any): string | Uint8Array | null {
  ...
  static addTargetName(builder: flatbuffers.Builder, targetNameOffset: flatbuffers.Offset) {
    builder.addFieldOffset(2, targetNameOffset, 0);
  }

  static addParamDocuments(builder: flatbuffers.Builder, paramDocumentsOffset: flatbuffers.Offset) {
    builder.addFieldOffset(3, paramDocumentsOffset, 0);
  }

  static createParamDocumentsVector(builder: flatbuffers.Builder, data: flatbuffers.Offset[]): flatbuffers.Offset {
  ...
  static startParamDocumentsVector(builder: flatbuffers.Builder, numElems: number) {
  ...
  unpackTo(_o: ExecuteRpcParamT): void {
    ...
    _o.paramDocuments = this.bb!.createScalarList<string>(this.paramDocuments.bind(this), this.paramDocumentsLength());
  }
}
...
export class ExecuteRpcParamT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    const targetName = this.targetName !== null ? builder.createString(this.targetName!) : 0;
    const paramDocuments = ExecuteRpcParam.createParamDocumentsVector(builder, builder.createObjectOffsetList(this.paramDocuments));

    return ExecuteRpcParam.createExecuteRpcParam(builder, this.by, className, targetName, paramDocuments);
  }
}
