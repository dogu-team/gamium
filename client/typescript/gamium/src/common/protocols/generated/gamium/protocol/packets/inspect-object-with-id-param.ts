...
export class InspectObjectWithIdParam implements flatbuffers.IUnpackableObject<InspectObjectWithIdParamT> {
  ...
  static getRootAsInspectObjectWithIdParam(bb: flatbuffers.ByteBuffer, obj?: InspectObjectWithIdParam): InspectObjectWithIdParam {
    return (obj || new InspectObjectWithIdParam()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsInspectObjectWithIdParam(bb: flatbuffers.ByteBuffer, obj?: InspectObjectWithIdParam): InspectObjectWithIdParam {
  ...
  static endInspectObjectWithIdParam(builder: flatbuffers.Builder): flatbuffers.Offset {
    const offset = builder.endObject();
    return offset;
  }

  static createInspectObjectWithIdParam(builder: flatbuffers.Builder, objectIdOffset: flatbuffers.Offset): flatbuffers.Offset {
...
export class InspectObjectWithIdParamT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return InspectObjectWithIdParam.createInspectObjectWithIdParam(builder, objectId);
  }
}
