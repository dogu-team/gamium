...
```
"com.dogu.gamium.engine.unity": "https://github.com/dogu-team/gamium.git?path=/engine/unity#latest",
```
...
Go to the topic `Other Settings -> Script Compilation` using the [Custom scripting symbols](https://docs.unity3d.com/Manual/CustomScriptingSymbols.html) guide and add **`USE_GAMIUM`**).
