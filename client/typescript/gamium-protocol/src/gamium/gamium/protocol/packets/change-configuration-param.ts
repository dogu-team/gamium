...
import {
  Configuration,
  ConfigurationT,
} from "../../../gamium/protocol/types/configuration.js";

export class ChangeConfigurationParam
  implements flatbuffers.IUnpackableObject<ChangeConfigurationParamT>
{
  ...
  static getRootAsChangeConfigurationParam(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeConfigurationParam
  ): ChangeConfigurationParam {
    return (obj || new ChangeConfigurationParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsChangeConfigurationParam(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeConfigurationParam
  ): ChangeConfigurationParam {
  ...
  static addConfig(
    ...
    configOffset: flatbuffers.Offset
  ) {
    builder.addFieldOffset(0, configOffset, 0);
  }

  static endChangeConfigurationParam(
    builder: flatbuffers.Builder
  ): flatbuffers.Offset {
  ...
  static createChangeConfigurationParam(
    builder: flatbuffers.Builder,
    configOffset: flatbuffers.Offset
  ): flatbuffers.Offset {
  ...
  unpack(): ChangeConfigurationParamT {
    return new ChangeConfigurationParamT(
...
export class ChangeConfigurationParamT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return ChangeConfigurationParam.createChangeConfigurationParam(
      builder,
      config
    );
  }
