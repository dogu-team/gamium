...
export class InspectObjectOnScreenResult implements flatbuffers.IUnpackableObject<InspectObjectOnScreenResultT> {
  ...
  static getRootAsInspectObjectOnScreenResult(bb: flatbuffers.ByteBuffer, obj?: InspectObjectOnScreenResult): InspectObjectOnScreenResult {
    return (obj || new InspectObjectOnScreenResult()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsInspectObjectOnScreenResult(bb: flatbuffers.ByteBuffer, obj?: InspectObjectOnScreenResult): InspectObjectOnScreenResult {
  ...
  static addHitPoint(builder: flatbuffers.Builder, hitPointOffset: flatbuffers.Offset) {
    builder.addFieldStruct(1, hitPointOffset, 0);
  }

  static endInspectObjectOnScreenResult(builder: flatbuffers.Builder): flatbuffers.Offset {
  ...
  unpack(): InspectObjectOnScreenResultT {
    return new InspectObjectOnScreenResultT(
      this.bb!.createObjList<ObjectInfo, ObjectInfoT>(this.infos.bind(this), this.infosLength()),
...
export class InspectObjectOnScreenResultT implements flatbuffers.IGeneratedObject {
  constructor(public infos: ObjectInfoT[] = [], public hitPoint: Vector3T | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const infos = InspectObjectOnScreenResult.createInfosVector(builder, builder.createObjectOffsetList(this.infos));

    InspectObjectOnScreenResult.startInspectObjectOnScreenResult(builder);
    InspectObjectOnScreenResult.addInfos(builder, infos);
    InspectObjectOnScreenResult.addHitPoint(builder, this.hitPoint !== null ? this.hitPoint!.pack(builder) : 0);
