...
export class InputSetTextParam
  implements flatbuffers.IUnpackableObject<InputSetTextParamT>
{
  ...
  static getRootAsInputSetTextParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InputSetTextParam
  ): InputSetTextParam {
    return (obj || new InputSetTextParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsInputSetTextParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InputSetTextParam
  ): InputSetTextParam {
  ...
  static createInputSetTextParam(
    builder: flatbuffers.Builder,
    objectIdOffset: flatbuffers.Offset,
