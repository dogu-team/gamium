...
import {
  ...
  unionToResult,
  unionListToResult,
} from "../../gamium/protocol/result.js";
import {
  ErrorResult,
  ErrorResultT,
} from "../../gamium/protocol/types/error-result.js";
...
export class Response implements flatbuffers.IUnpackableObject<ResponseT> {
  ...
  static getSizePrefixedRootAsResponse(
    bb: flatbuffers.ByteBuffer,
    obj?: Response
  ): Response {
  ...
  static finishSizePrefixedResponseBuffer(
    builder: flatbuffers.Builder,
    offset: flatbuffers.Offset
  ) {
