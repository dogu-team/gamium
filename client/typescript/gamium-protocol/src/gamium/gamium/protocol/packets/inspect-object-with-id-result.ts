...
export class InspectObjectWithIdResult
  implements flatbuffers.IUnpackableObject<InspectObjectWithIdResultT>
{
  ...
  static getRootAsInspectObjectWithIdResult(
    bb: flatbuffers.ByteBuffer,
    obj?: InspectObjectWithIdResult
  ): InspectObjectWithIdResult {
    return (obj || new InspectObjectWithIdResult()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsInspectObjectWithIdResult(
    bb: flatbuffers.ByteBuffer,
    obj?: InspectObjectWithIdResult
  ): InspectObjectWithIdResult {
  ...
  static endInspectObjectWithIdResult(
  ...
  static createInspectObjectWithIdResult(
    builder: flatbuffers.Builder,
    infoOffset: flatbuffers.Offset
  ): flatbuffers.Offset {
  ...
  unpack(): InspectObjectWithIdResultT {
    return new InspectObjectWithIdResultT(
...
export class InspectObjectWithIdResultT
  implements flatbuffers.IGeneratedObject
{
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return InspectObjectWithIdResult.createInspectObjectWithIdResult(
      builder,
      info
    );
  }
