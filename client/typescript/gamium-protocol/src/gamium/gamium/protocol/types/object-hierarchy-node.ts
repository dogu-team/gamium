...
export class ObjectHierarchyNode
  implements flatbuffers.IUnpackableObject<ObjectHierarchyNodeT>
{
  ...
  static getRootAsObjectHierarchyNode(
    bb: flatbuffers.ByteBuffer,
    obj?: ObjectHierarchyNode
  ): ObjectHierarchyNode {
    return (obj || new ObjectHierarchyNode()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsObjectHierarchyNode(
    bb: flatbuffers.ByteBuffer,
    obj?: ObjectHierarchyNode
  ): ObjectHierarchyNode {
...
export class ObjectHierarchyNodeT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    const children = ObjectHierarchyNode.createChildrenVector(
      builder,
      builder.createObjectOffsetList(this.children)
    );

    return ObjectHierarchyNode.createObjectHierarchyNode(
      builder,
      name,
      path,
      children
