...
export class ChangeConfigurationResult
  implements flatbuffers.IUnpackableObject<ChangeConfigurationResultT>
{
  ...
  static getRootAsChangeConfigurationResult(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeConfigurationResult
  ): ChangeConfigurationResult {
    return (obj || new ChangeConfigurationResult()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsChangeConfigurationResult(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeConfigurationResult
  ): ChangeConfigurationResult {
  ...
  static endChangeConfigurationResult(
  ...
  static createChangeConfigurationResult(
    builder: flatbuffers.Builder
  ): flatbuffers.Offset {
...
export class ChangeConfigurationResultT
