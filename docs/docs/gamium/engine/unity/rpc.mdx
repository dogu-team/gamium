...
The following C# code can be invoked through the function [executeRpc](../../gamium-client/api/client/typescript/classes/gamium-client#executeRpc-) in `Gamium Client`.
