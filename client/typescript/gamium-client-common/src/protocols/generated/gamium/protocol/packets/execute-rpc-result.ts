...
export class ExecuteRpcResult
  implements flatbuffers.IUnpackableObject<ExecuteRpcResultT>
{
  ...
  static getRootAsExecuteRpcResult(
    bb: flatbuffers.ByteBuffer,
    obj?: ExecuteRpcResult
  ): ExecuteRpcResult {
    return (obj || new ExecuteRpcResult()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsExecuteRpcResult(
    bb: flatbuffers.ByteBuffer,
    obj?: ExecuteRpcResult
  ): ExecuteRpcResult {
  ...
  static addDocument(
    ...
    documentOffset: flatbuffers.Offset
  ) {
...
export class ExecuteRpcResultT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const document =
      this.document !== null ? builder.createString(this.document!) : 0;
