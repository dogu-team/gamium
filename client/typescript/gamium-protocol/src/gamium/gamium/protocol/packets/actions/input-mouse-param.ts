...
import {
  Vector2,
  Vector2T,
} from "../../../../gamium/protocol/types/vector2.js";

export class InputMouseParam
  implements flatbuffers.IUnpackableObject<InputMouseParamT>
{
  ...
  static getRootAsInputMouseParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InputMouseParam
  ): InputMouseParam {
    return (obj || new InputMouseParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsInputMouseParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InputMouseParam
  ): InputMouseParam {
  ...
  static addDelta(
    builder: flatbuffers.Builder,
    deltaOffset: flatbuffers.Offset
  ) {
...
export class InputMouseParamT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    InputMouseParam.addPosition(
      builder,
      this.position !== null ? this.position!.pack(builder) : 0
    );
    InputMouseParam.addDelta(
      builder,
      this.delta !== null ? this.delta!.pack(builder) : 0
    );
