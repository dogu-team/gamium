...
export class ObjectLocator implements flatbuffers.IUnpackableObject<ObjectLocatorT> {
  ...
  static getRootAsObjectLocator(bb: flatbuffers.ByteBuffer, obj?: ObjectLocator): ObjectLocator {
    return (obj || new ObjectLocator()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsObjectLocator(bb: flatbuffers.ByteBuffer, obj?: ObjectLocator): ObjectLocator {
  ...
  by(): ObjectLocatorBy {
    ...
    return offset ? this.bb!.readInt16(this.bb_pos + offset) : ObjectLocatorBy.Path;
  }
  ...
  static createObjectLocator(builder: flatbuffers.Builder, by: ObjectLocatorBy, strOffset: flatbuffers.Offset): flatbuffers.Offset {
...
export class ObjectLocatorT implements flatbuffers.IGeneratedObject {
  constructor(public by: ObjectLocatorBy = ObjectLocatorBy.Path, public str: string | Uint8Array | null = null) {}
