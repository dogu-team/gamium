...
export class ErrorResult implements flatbuffers.IUnpackableObject<ErrorResultT> {
  ...
  static getRootAsErrorResult(bb: flatbuffers.ByteBuffer, obj?: ErrorResult): ErrorResult {
    return (obj || new ErrorResult()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsErrorResult(bb: flatbuffers.ByteBuffer, obj?: ErrorResult): ErrorResult {
  ...
  static createErrorResult(builder: flatbuffers.Builder, code: ErrorCode, reasonOffset: flatbuffers.Offset): flatbuffers.Offset {
...
export class ErrorResultT implements flatbuffers.IGeneratedObject {
  constructor(public code: ErrorCode = ErrorCode.None, public reason: string | Uint8Array | null = null) {}
