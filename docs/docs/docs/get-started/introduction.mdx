...
If you've used an automation library like [Selenium](https://www.selenium.dev/), [Appium](https://appium.io/), or [Playwright](https://playwright.dev/) beforehand, it's also a good idea to look around the [Client document](/docs/client/write-testscript) to see what it does.
