...
import {
  Vector3,
  Vector3T,
} from "../../../../gamium/protocol/types/vector3.js";

export class MovePlayerParam
  implements flatbuffers.IUnpackableObject<MovePlayerParamT>
{
  ...
  static getRootAsMovePlayerParam(
    bb: flatbuffers.ByteBuffer,
    obj?: MovePlayerParam
  ): MovePlayerParam {
    return (obj || new MovePlayerParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsMovePlayerParam(
    bb: flatbuffers.ByteBuffer,
    obj?: MovePlayerParam
  ): MovePlayerParam {
  ...
  static addPlayerObjectId(
    builder: flatbuffers.Builder,
    playerObjectIdOffset: flatbuffers.Offset
  ) {
    builder.addFieldOffset(0, playerObjectIdOffset, 0);
  }

  static addCameraObjectId(
    builder: flatbuffers.Builder,
    cameraObjectIdOffset: flatbuffers.Offset
  ) {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const playerObjectId =
      this.playerObjectId !== null
        ? builder.createString(this.playerObjectId!)
        : 0;
    const cameraObjectId =
      this.cameraObjectId !== null
        ? builder.createString(this.cameraObjectId!)
        : 0;
