...
export class InspectObjectOnScreenParam
  implements flatbuffers.IUnpackableObject<InspectObjectOnScreenParamT>
{
  ...
  static getRootAsInspectObjectOnScreenParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InspectObjectOnScreenParam
  ): InspectObjectOnScreenParam {
    return (obj || new InspectObjectOnScreenParam()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb
    );
  }

  static getSizePrefixedRootAsInspectObjectOnScreenParam(
    bb: flatbuffers.ByteBuffer,
    obj?: InspectObjectOnScreenParam
  ): InspectObjectOnScreenParam {
  ...
  static addScreenSize(
    builder: flatbuffers.Builder,
    screenSizeOffset: flatbuffers.Offset
  ) {
    builder.addFieldStruct(1, screenSizeOffset, 0);
  }

  static endInspectObjectOnScreenParam(
    builder: flatbuffers.Builder
  ): flatbuffers.Offset {
  ...
  unpack(): InspectObjectOnScreenParamT {
    return new InspectObjectOnScreenParamT(
      this.pos() !== null ? this.pos()!.unpack() : null,
      this.screenSize() !== null ? this.screenSize()!.unpack() : null
    );
  }
...
export class InspectObjectOnScreenParamT
  implements flatbuffers.IGeneratedObject
{
  constructor(
    public pos: Vector2T | null = null,
    public screenSize: Vector2T | null = null
  ) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    InspectObjectOnScreenParam.startInspectObjectOnScreenParam(builder);
    InspectObjectOnScreenParam.addPos(
      builder,
      this.pos !== null ? this.pos!.pack(builder) : 0
    );
    InspectObjectOnScreenParam.addScreenSize(
      builder,
      this.screenSize !== null ? this.screenSize!.pack(builder) : 0
    );
