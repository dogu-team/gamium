...
The `Gamium Client` allows keyboard input to be transferred using the function [sendKey] (../gamium-client/api/client/typescript/classes/gamium-client#sendkey-).
